...
| ID | 功能 | 说明 | 工期 | Phase |
|---|---|---|---|---|
| V2-001 | 多租户隔离 | Tenant ID + 资源隔离 + PG RLS | 3 周 | Phase 1 |
| V2-002 | 完整 Web 控制台 | React/Vue + 密钥管理 + 审计 + MFA + RBAC | 4 周 | Phase 2 |
| V2-003 | HSM 集群集成 | AWS CloudHSM / Azure / 华为 / 卫士通 | 2 周 | Phase 2 |
| V2-004 | KMIP 1.4/2.1 协议 | 金融/电信标准协议 | 2 周 | Phase 3 |
| V2-005 | Grants（临时授权） | 临时凭证 + 自动过期 + 撤销 | 1 周 | Phase 2 |
