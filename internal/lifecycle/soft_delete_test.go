...
func TestSoftDeleteKey_Success(t *testing.T) {
	...
	_, _, err := mgr.CreateKey(ctx, "soft-del-test", seal.NewSoftwareKEK(mk), 0)
	if err != nil {
...
func TestSoftDeleteKey_Idempotent(t *testing.T) {
	...
	_, _, _ = mgr.CreateKey(ctx, "idempotent-test", seal.NewSoftwareKEK(mk), 0)
...
func TestSoftDeleteKey_DestroyedRejected(t *testing.T) {
	...
	_, _, _ = mgr.CreateKey(ctx, "destroyed-test", seal.NewSoftwareKEK(mk), 0)
...
func TestRestoreKey_Success(t *testing.T) {
	...
	_, _, _ = mgr.CreateKey(ctx, "restore-test", seal.NewSoftwareKEK(mk), 0)
...
func TestRestoreKey_NotSoftDeleted(t *testing.T) {
	...
	_, _, _ = mgr.CreateKey(ctx, "active-restore", seal.NewSoftwareKEK(mk), 0)
...
func TestRestoreKey_DestroyedRejected(t *testing.T) {
	...
	_, _, _ = mgr.CreateKey(ctx, "restore-destroyed", seal.NewSoftwareKEK(mk), 0)
...
func TestSoftDeleted_CanDecrypt(t *testing.T) {
	...
	_, _, _ = mgr.CreateKey(ctx, "decrypt-after-softdel", seal.NewSoftwareKEK(mk), 0)
...
func TestSoftDeleted_CannotEncrypt(t *testing.T) {
	...
	_, _, _ = mgr.CreateKey(ctx, "encrypt-after-softdel", seal.NewSoftwareKEK(mk), 0)
	_ = mgr.SoftDeleteKey(ctx, "encrypt-after-softdel", 1)

	// 轮转后 V1 是 Deactivated，GetActiveKey 应返回 V2。
	_, _, _ = mgr.RotateKey(ctx, "encrypt-after-softdel", seal.NewSoftwareKEK(mk))
...
func TestSoftDeleteThenShred(t *testing.T) {
	...
	_, _, _ = mgr.CreateKey(ctx, "soft-then-shred", seal.NewSoftwareKEK(mk), 0)
...
func TestFullSoftDeleteRestoreShredLifecycle(t *testing.T) {
	...
	// 1. 创建 V1。
	_, _, _ = mgr.CreateKey(ctx, keyID, seal.NewSoftwareKEK(mk), 0)
